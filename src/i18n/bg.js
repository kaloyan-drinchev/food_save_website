export default {
  landing: {
    ...
    dl_client_desc: 'Намери и резервирай намалена излишна храна от местни бизнеси, или управлявай своите предложения като собственик.',
    ...
    impact_sub: 'Всяко спасено ястие има значение. Ето колективното въздействие, което нашата общност вече е постигнала.',
    ...
    review1_text: 'Спестих €12 от пекарски пакет, който щеше да бъде изхвърлен. Приложението е толкова лесно за ползване — намерих офертата, платих за секунди, взех за 10 минути.',
    review1_role: 'Студент, София',
    review2_text: 'Като собственик на ресторант, FoodSave ми помага да възстановя пари, които преди просто губех. Създаването на оферта отнема по-малко от минута и поръчките идват почти веднага.',
    review2_role: 'Собственик на ресторант, Пловдив',
    review3_text: 'Изгледът с карта е страхотен. Виждам всичко налично наблизо в момента. Намерих невероятна суши оферта на две улици от мен, за която никога нямаше да разбера.',
    review3_role: 'Гастроном, Варна',
    review4_text: 'Моята „Hero" значка вече е на ниво 4! Има нещо пристрастяващо в това да виждаш как нарастват общите ти спестявания — проверявам приложението всяка вечер преди вечеря.',
    review4_role: 'Редовен потребител, София',
    review5_text: 'Преди изхвърляхме сладкиши за €200 всяка седмица. С FoodSave продаваме 90 % от излишъка и QR системата за вземане е съвсем лесна за персонала.',
    review5_role: 'Собственик на пекарна, Бургас',
    review6_text: 'Обичам, че всяко ястие има пълна информация за алергени. Като човек с алергия към ядки, това винаги беше проблем с приложенията за храна — FoodSave го е решило перфектно.',
