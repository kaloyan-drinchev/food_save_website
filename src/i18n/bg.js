export default {
  landing: {
    ...
    hero_sub:
      'Купи излишна храна от местни ресторанти, пекарни и магазини с до\u00A0<strong>70\u00A0% отстъпка</strong>. Спести пари, яж добре и помогни за намаляване на хранителните отпадъци — с едно докосване.',
    ...
    step2_desc:
      'Избери конкретна оферта от менюто и я запази с до 70\u00A0% отстъпка от оригиналната цена. Плати в приложението с карта, Google Pay, Revolut или PayPal.',
    step3_num: '03',
    step3_title: 'Вземи',
    step3_desc:
