  ...
  >
    ...
    <div class="nav-desktop-links">
      <div class="nav-pill-group">
        <RouterLink to="/#about" class="nav-link" :class="{ 'active-link': activePage === 'about' }">
          {{ t('nav.about') }}
        </RouterLink>
        <RouterLink to="/#download" class="nav-link" :class="{ 'active-link': activePage === 'download' }">
          {{ t('nav.download') }}
        </RouterLink>
        <RouterLink to="/privacy" class="nav-link" :class="{ 'active-link': activePage === 'privacy' }">
          {{ t('nav.privacy') }}
        </RouterLink>
        <RouterLink to="/terms" class="nav-link" :class="{ 'active-link': activePage === 'terms' }">
          {{ t('nav.terms') }}
        </RouterLink>
        <RouterLink to="/#contact" class="nav-link" :class="{ 'active-link': activePage === 'contact' }">
          {{ t('nav.contact') }}
        </RouterLink>
      </div>
    </div>
    ...
    <div class="nav-right-group">
      ...
      <button class="theme-toggle" :aria-label="theme === 'dark' ? 'Switch to light mode' : 'Switch to dark mode'" @click="toggleTheme">
